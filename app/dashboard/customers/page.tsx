...
import { 
  ...
  Users, TrendingUp, ChevronUp, ChevronDown, 
  ArrowLeft, Eye
} from "lucide-react";
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <header className="lg:hidden fixed top-0 left-0 right-0 z-40 bg-white border-b border-slate-200">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <h1 className="text-lg font-semibold text-slate-800">Khách hàng</h1>
          <div className="w-9" />
        </div>
      </header>
              ...
              <div className="p-4 space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  <a
                    ...
                    className="flex-1 flex items-center justify-center gap-2 py-3 bg-blue-600 text-white rounded-xl font-medium"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 flex items-center justify-center gap-2 py-3 bg-blue-50 text-blue-600 rounded-xl font-medium"
                  >
